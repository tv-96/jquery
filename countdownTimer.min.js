...
$(document).ready(function(){$(".date").each(function(){var a=$(this),b=a.data("start"),c=a.data("gameends"),d=moment(b,"YYYY/MM/DD HH:mm"),e=moment(c,"YYYY/MM/DD HH:mm"),f=moment.utc().format("YYYY/MM/DD HH:mm"),g=d.diff(f,"minutes"),h=e.diff(f,"minutes");switch(!0){case 1<g:var i=moment.utc(b).toDate();i=moment(i).format("YYYY/MM/DD HH:mm"),a.countdowntimer({dateAndTime:i});break;case 0<g:i=moment.utc(b).toDate(),a.html("بعد قليل").addClass("comming-soon");break;case 0<h:a.html("مباشر ").addClass("live"),i=moment.utc(b).toDate();break;default:i=moment.utc(b).toDate(),a.html("إنتهت").addClass("ended");}});});
